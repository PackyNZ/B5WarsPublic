...
/**
 * A Ship represents a typical space faring vessel
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public abstract class Ship extends StructuralUnit implements MobileUnit {

	private static final String NOT_APPLICABLE = "N/A";
	
	private static final long serialVersionUID = -789846625629777943L;

	private final String    turnCostFormatted;          // formatted thrust cost to make a turn 
	private final double    turnCost;                   // thrust cost to make a turn 
	private final String    turnDelayFormatted;         // formatted mandatory movement delay between making turns 
	private final double    turnDelay;                  // mandatory movement delay between making turns 
	 ...
	 */
	protected Ship(final String name, final String model, final String hull, final int version, 
