...
/**
 * A CapitalShip is a larger combat vessel such as battleships, dreadnoughts, heavy cruisers, 
 * light cruisers, destroyers, heavy carriers, most scouts, and exploration vessels
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class CapitalShip extends Ship {
	
	private static final long serialVersionUID = 5380222429099682204L;
	 ...
	 */
	public CapitalShip(final String name, final String model, final String hull, final int version, 
