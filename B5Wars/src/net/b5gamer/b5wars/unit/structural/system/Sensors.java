...
/**
 * !!--- work in progress ---!!
 * Sensors provide electronic warfare (EW) capabilities for a vessel
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class Sensors extends PoweredSystem {

	private static final long serialVersionUID = -7653070437439447307L;

	private final int baseSensorRating; // base amount of EW points produced by the sensors per turn
	private       int sensorRating;     // amount of EW points produced by the sensors per turn

	/**
	 * @param damageBoxes amount of damage the sensors can sustain before being destroyed
	 * @param armor       amount of armor protecting the sensors
	 * @param arc         arc for incoming fire, may be null
	 * @param name        name of the sensors, may be null
	 * @param properties  additional properties 
	 */
	public Sensors(final int damageBoxes, final int armor, final Arc arc, final String name,
	 ...
	 * @param arc          arc for incoming fire, may be null
	 * @param name         name of the sensors, may be null
	 * @param power        amount of power required for the sensors to function
	 * @param sensorRating amount of EW points produced by the sensors per turn
	 */
	public Sensors(final int damageBoxes, final int armor, final Arc arc, final String name,
	...
	/**
	 * the base amount of EW points produced by the sensors per turn
	 * 
	 * @return the base amount of EW points produced by the sensors per turn
	 */
	...
	/**
	 * the amount of EW points produced by the sensors per turn
	 * 
	 * @return the amount of EW points produced by the sensors per turn
	 */
	 ...
	 * the amount of EW points produced by the sensors per turn
	 * 
	 * @param sensorRating the amount of EW points produced by the sensors per turn
	 */
