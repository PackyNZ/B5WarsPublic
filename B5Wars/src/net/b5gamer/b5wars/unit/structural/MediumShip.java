...
/**
 * A MediumShip is a swift and maneuverable vessel such as frigates, light escorts, fast 
 * warships, police craft, corvettes, and many civilian freighters or support vehicles
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class MediumShip extends Ship {
	
	private static final long serialVersionUID = 3420785506248353184L;
	 ...
	 */
	public MediumShip(final String name, final String model, final String hull, final int version, 
