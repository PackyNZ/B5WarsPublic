...
/**
 * An EnormousUnit is a huge vessel
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class EnormousUnit extends Ship {

	private static final long serialVersionUID = -7803979919938010540L;
	 ...
	 */
	public EnormousUnit(final String name, final String model, final String hull, final int version, 
