...
/**
 * !!--- work in progress ---!!
 * HeavyFighters is a group of one of more of the same type of heavy fighter 
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class HeavyFighters extends FighterFlight {

	private static final long serialVersionUID = -6535858722894854548L;
	 ...
	 */
	public HeavyFighters(final String name, final String model, final String hull, final int version, 
