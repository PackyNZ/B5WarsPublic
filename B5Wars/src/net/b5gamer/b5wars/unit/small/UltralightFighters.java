...
/**
 * !!--- work in progress ---!!
 * UltralightFighters is a group of one of more of the same type of ultra-light fighter 
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class UltralightFighters extends FighterFlight {

	private static final long serialVersionUID = 4510249964570361708L;
	 ...
	 */
	public UltralightFighters(final String name, final String model, final String hull, final int version, 
	...
	public String getType() {
		return "Ultralight Fighters";
	}
	
	public int getJinkingLimit() {
		// unlimited jinking limit, so only limited by amount of available thrust
		return getFreeThrust(); 
	}
