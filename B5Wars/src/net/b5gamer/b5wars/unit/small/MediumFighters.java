...
/**
 * !!--- work in progress ---!!
 * MediumFighters is a group of one of more of the same type of medium fighter 
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class MediumFighters extends FighterFlight {

	private static final long serialVersionUID = 4400429606776064726L;
	 ...
	 */
	public MediumFighters(final String name, final String model, final String hull, final int version, 
