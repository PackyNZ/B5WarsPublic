...
/**
 * !!--- work in progress ---!!
 * LightFighters is a group of one of more of the same type of light fighter 
 * 
 * @author Alex Packwood (aka PackyNZ)
 */
public class LightFighters extends FighterFlight {

	private static final long serialVersionUID = 963316793773874210L;
	 ...
	 */
	public LightFighters(final String name, final String model, final String hull, final int version, 
